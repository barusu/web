<template>
  <main class="album">
    <div class="sidebar">
      <div class="oo-menu">
        <p class="oo-menu-title"> <span>Album</span> </p>
        <input type="checkbox" id="ck_game" class="oo-ck">
        <p class="oo-menu-group">
          <label for="ck_game" class="oo-menu-group-title">
            <div>Game Album</div>
            <span class="oo-arrow"></span>
          </label>
          <ul class="oo-menu-item-list">
            <li class="oo-menu-item"> <router-link :to="{name: 'tabikaeru'}">旅かえる</router-link> </li>
          </ul>
        </p>
      </div>
    </div>
